# Fashion-Marketing-Sales-Analysis---PowerBI---
## I. Introduction

### 1. Company Overview to Dataset
This company operates in the fashion industry, primarily focusing on retail and e-commerce. The company runs multiple multi-channel marketing campaigns (both online and offline) to boost sales and strengthen brand awareness.
  
The dataset includes total revenue information (the “Order” table), which already incorporates revenue generated from advertising (the “mkt_camp_by_sku_cost” table). It also contains marketing spending data such as budget, CPM, CPC, CTR, etc. (the “mkt_camp_cost” table), along with product categories and classifications to support the analysis of sales performance and marketing investment effectiveness. Additionally, the “Sample Description” sheet provides guidance on how to calculate key marketing performance metrics for each SKU within each campaign.

### 2. Business Objective
Build a tactical report to help company leaders understand marketing budget allocation and campaign performance. The report should link sales revenue with marketing spending, evaluate marketing budget efficiency based on key KPIs, and provide strategic recommendations to improve marketing performance.
...
<img width="1440" height="1116" alt="image" src="https://github.com/user-attachments/assets/51906424-309b-4f39-a401-7d322d10fe1e" />
